...
seqlevels(mut_gr) <- paste0("chr", seqlevels(mut_gr))

overlaps <- findOverlaps(mut_gr, peaks_gr) #296 hits what does it mean?

peaks_mut_overlap <- as.data.frame(mcols(peaks_gr[subjectHits(overlaps)])) #subjectHits gives peak indices
